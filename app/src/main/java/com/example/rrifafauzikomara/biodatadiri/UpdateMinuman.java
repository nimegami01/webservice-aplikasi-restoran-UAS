...
public class UpdateMinuman extends AppCompatActivity {
    ...
    private void getMinuman(){
        class GetMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://nimegami123.000webhostapp.com/webservice/tugas5/Minuman/get_minuman.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMinuman(){
        ...
        class UpMinuman extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://nimegami123.000webhostapp.com/webservice/tugas5/Minuman/update_minuman.php", hashMap);
    ...
    private void deleteMinuman(){
        class DeleteMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://nimegami123.000webhostapp.com/webservice/tugas5/Minuman/delete_minuman.php?no=", id);
                return s;
            }
        }
