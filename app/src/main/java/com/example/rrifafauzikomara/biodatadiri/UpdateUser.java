...
public class UpdateUser extends AppCompatActivity {
    ...
    private void getUser(){
        class GetUser extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://nimegami123.000webhostapp.com/webservice/tugas5/User/get_user.php?id=",id);
                return s;
            }
        }
    ...
    private void updateUser(){
        ...
        class UpdateUsers extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://nimegami123.000webhostapp.com/webservice/tugas5/User/update_user.php", hashMap);
    ...
    private void deleteUser(){
        class DeleteUser extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://nimegami123.000webhostapp.com/webservice/tugas5/User/delete_user.php?id=", id);
                return s;
            }
        }
